...
export default function Correction() {
  ...
  const fetchServiceCharge = async () => {
    ...
    try {
      const response = await serviceChargeAPI.getChargeByDocumentType('name-correction');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const uploadResult = await uploadPDFToCloudinary(pdfBlob, 'name-correction', requestId);
          ...
          >
            ...
            <div style={{ marginLeft: "0px" }}>
              <p style={{ margin: "10px 0" }}>
                1. That my name as per my <b>{data.documentType1 || "__________"}</b> is <b>{data.nameAsPerDoc1 || "__________"}</b> and my name as per my <b>{data.documentType2 || "__________"}</b> is <b>{data.nameAsPerDoc2 || "__________"}</b>.
              </p>

              <p style={{ margin: "10px 0" }}>
                2. That I undertake that both names <b>{data.nameAsPerDoc1 || "__________"}</b> and <b>{data.nameAsPerDoc2 || "__________"}</b> refer to the one and same person, i.e., <b>{data.oldName || "__________"}</b>.
              </p>

              <p style={{ margin: "10px 0" }}>
                3. That I will be known as <b>{data.newName || "__________"}</b> in future for all purposes.
              </p>
