...
export default function WhatWeDoAndHowItWorks() {
  const services = [
    {
      ...
      icon: Home,
      gradient: "from-[#60AF70] to-emerald-600",
    },
    {
      ...
      icon: Building2,
      gradient: "from-emerald-500 to-[#60AF70]",
    },
    {
      ...
      icon: FileSignature,
      gradient: "from-teal-500 to-[#60AF70]",
    },
    {
      ...
      icon: ScrollText,
      gradient: "from-[#60AF70] to-green-600",
    },
    {
      ...
      icon: Stamp,
      gradient: "from-emerald-600 to-[#60AF70]",
    },
    {
      ...
      icon: FileCheck,
      gradient: "from-green-500 to-[#60AF70]",
    },
  ];
  ...
  return (
    <section className="relative py-28 overflow-hidden bg-gradient-to-br from-slate-50 via-emerald-50/30 to-white">
      {/* Background decor */}
      <div className="absolute -top-32 -left-32 h-96 w-96 bg-[#60AF70]/20 rounded-full blur-3xl" />
      <div className="absolute -bottom-32 -right-32 h-96 w-96 bg-emerald-300/20 rounded-full blur-3xl" />

      <div className="relative max-w-7xl mx-auto px-6 space-y-32">
        {/* WHAT WE DO Section */}
        <div className="space-y-16">
          <div className="text-center space-y-4">
            <span className="inline-block px-4 py-1.5 rounded-full bg-[#60AF70]/10 text-[#60AF70] text-sm font-semibold tracking-wide">
              OUR SERVICES
            </span>
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-12 space-y-4">
                    ...
                    <div className="flex items-center gap-2 text-[#60AF70] font-medium text-sm group-hover:gap-3 transition-all">
                      Learn More
                      <ArrowRight size={14} />
                    </div>
                  </div>
        ...
        <div className="space-y-16">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* Animated connector */}
            <div className="hidden md:block absolute top-1/2 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#60AF70]/40 to-transparent" />
            ...
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  {/* Step number */}
                  <span className="absolute -top-5 -left-5 h-12 w-12 rounded-xl bg-[#60AF70] text-white flex items-center justify-center font-bold shadow-lg group-hover:scale-110 transition">
                    {i + 1}
                  </span>

                  {/* Glow */}
                  <div className="absolute inset-0 rounded-3xl bg-[#60AF70]/10 opacity-0 group-hover:opacity-100 blur-xl transition" />

                  <div className="relative space-y-5">
                    <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-[#60AF70] to-emerald-600 text-white flex items-center justify-center shadow-md group-hover:rotate-6 transition">
                      <Icon size={28} />
                    </div>
        ...
        <div className="space-y-16">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900">
              Our <span className="text-[#60AF70]">Bestsellers</span>
            </h2>
            <p className="max-w-2xl mx-auto text-slate-600">
