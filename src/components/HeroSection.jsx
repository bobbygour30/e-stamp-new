...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-emerald-50/30 to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl font-bold leading-tight text-slate-900">
            ...
            <span className="text-[#60AF70]"> Verified e-Stamping</span>
          </h1>
          ...
          <div className="flex items-center w-full max-w-xl bg-white rounded-xl shadow-lg overflow-hidden border border-slate-100">
            ...
            />
            <button className="px-6 py-4 bg-[#60AF70] text-white hover:bg-[#4a8c58] transition-colors">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a
              href="#"
              className="px-6 py-3 rounded-xl bg-[#60AF70] text-white font-medium hover:bg-[#4a8c58] transition-all shadow-md hover:shadow-lg"
            >
              Get Started
            </a>
            <a
              href="#"
              className="px-6 py-3 rounded-xl border border-slate-300 text-slate-700 font-medium hover:border-[#60AF70] hover:text-[#60AF70] transition-all"
            >
              Explore Services
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-6 pt-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              <Stamp size={16} className="text-[#60AF70]" />
        ...
        <div className="relative animate-slide-up">
          <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm shadow-2xl p-6 border border-slate-100">
            <div className="absolute -top-4 -right-4 h-20 w-20 rounded-xl bg-[#60AF70] text-white flex items-center justify-center font-semibold shadow-lg">
              <Stamp size={28} />
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="rounded-xl bg-gradient-to-br from-emerald-50 to-white p-5 text-center border border-emerald-100 shadow-sm">
                  <p className="text-3xl font-bold text-[#60AF70]">27+</p>
                  <p className="text-sm text-slate-600 font-medium">States Covered</p>
                </div>
                <div className="rounded-xl bg-gradient-to-br from-emerald-50 to-white p-5 text-center border border-emerald-100 shadow-sm">
                  <p className="text-3xl font-bold text-[#60AF70]">8+</p>
                  <p className="text-sm text-slate-600 font-medium">Years Experience</p>
                </div>
                <div className="rounded-xl bg-gradient-to-br from-emerald-50 to-white p-5 text-center border border-emerald-100 shadow-sm">
                  <p className="text-3xl font-bold text-[#60AF70]">1M+</p>
                  <p className="text-sm text-slate-600 font-medium">Happy Users</p>
                </div>
                <div className="rounded-xl bg-gradient-to-br from-emerald-50 to-white p-5 text-center border border-emerald-100 shadow-sm">
                  <p className="text-3xl font-bold text-[#60AF70]">99.9%</p>
              ...
              <div className="flex items-center justify-center gap-2 pt-2 text-sm text-slate-500 border-t border-slate-100 pt-4">
                <ShieldCheck size={14} className="text-[#60AF70]" />
